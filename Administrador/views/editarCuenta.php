                    ...
                    <div class="ancho-60">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link tamaño1 active" href="index.php?a=agregarUsuario">Agregar Usuario</a>
                                </li>
                                <li class="nav-item">
        ...
        <section>
                <div class="inicio_sesion">
                    <div class="caja caja1 col-lg-7 col-md-9 col-xs-9">
                        ...
                        <form action="index.php?a=actualizarCuentaAdmin" id="formEditarCuenta" class="formEditarCuenta" method="POST">
