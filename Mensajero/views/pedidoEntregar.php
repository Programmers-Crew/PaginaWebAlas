...
<html lang="es">
    <head>
        <title>AlasGT - Entregar Pedido</title>
        ...
        <header style="padding: 0;">
            ...
            <section>
                ...
                <div class="col-xl-12 col-md-12 col-xs-12 centrado"  >
                    <div  class='col-lg-5 col-md-9 col-xs-9 pedidos'>
                        <form enctype="multipart/form-data" class="col-xl-12 col-md-12 col-xs-12 fuentes" id="formEntregar" method="POST" action="index.php?a=entregarPedido">
                            ...
                            ?>  
                               <input id="fichero"  name="imagen" accept="image/*" type="file">
                              <label id="boton" class="custom-btn btn-3" for="fichero"><span style="padding-left:8px">Seleccionar Imagen</span></label>
                              <span id="texto">Ningún archivo seleccionado</span>
                              <input value="<?php echo $_GET['id']?>" name="id" type="hidden">
                              <input type="hidden" value="<?php echo $nombreReceptor ?>" name="nombreReceptor">
                              <input type="hidden" value="<?php  echo $descFinal?>" name="descFinal">
                              <input type="hidden" value="<?php echo $costo?>" name="costo">
